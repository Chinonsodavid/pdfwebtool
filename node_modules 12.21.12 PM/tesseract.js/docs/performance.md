...
Tesseract.js needs to be able to pick between these filessetting `corePath` to a specific `.js` file will significantly degrade performance or compatibility.
