...
export const trustPages = {
  about: {
    ...
    eyebrow: 'About',
    intro: 'PDFForge is a browser-based document toolkit for everyday PDF, image, spreadsheet, and presentation workflows.',
    sections: [
      {
        heading: 'What PDFForge does',
        body: [
          'PDFForge helps users merge, split, compress, convert, protect, unlock, sign, crop, label, OCR, and organize documents from one clean interface.',
      ...
      },
      {
        ...
        body: [
          ...
          'PDFForge is not a permanent file hosting service. Users should download their result and keep their own secure copy.',
        ],
      },
      {
  ...
  contact: {
    title: 'Contact',
    eyebrow: 'Support',
    intro: 'Questions, bug reports, and business enquiries can be sent to the PDFForge support contact.',
    sections: [
      {
        heading: 'Email',
        body: [
      ...
      },
      {
        ...
        body: [
          'PDFForge aims to respond to genuine support and business enquiries as quickly as possible.',
  ...
  privacy: {
    ...
    eyebrow: 'Privacy',
    intro: 'This policy explains the kinds of information PDFForge may process when users access the website and use document tools.',
    sections: [
      {
        heading: 'Information processed',
        body: [
          'PDFForge may process uploaded files, generated output files, IP address, browser information, device information, basic request logs, and error logs needed to operate and secure the service.',
          'Uploaded files are used to complete the selected document task. PDFForge does not sell uploaded documents.',
        ],
      },
      {
        ...
        body: [
          ...
          'Users should download their processed files promptly. PDFForge is not designed for long-term file storage.',
        ],
      },
      {
  ...
  terms: {
    ...
    eyebrow: 'Terms',
    intro: 'By using PDFForge, users agree to use the tools responsibly and only for documents they have the right to process.',
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          ...
          'PDFForge does not claim ownership of user documents, but needs to process uploaded files temporarily to provide the selected tool.',
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          'PDFForge may be unavailable during maintenance, hosting interruptions, or heavy processing load.',
  ...
  cookies: {
    title: 'Cookie Policy',
    eyebrow: 'Cookies',
    intro: 'This page explains how cookies and similar technologies may be used on PDFForge.',
    sections: [
      {
  ...
  disclaimer: {
    ...
    intro: 'PDFForge provides document tools for convenience. It is not a legal, financial, accounting, medical, or professional advice service.',
    sections: [
      {
  ...
  copyright: {
    ...
    eyebrow: 'Copyright',
    intro: 'PDFForge respects intellectual property rights and expects users to do the same.',
    sections: [
      {
        heading: 'User responsibility',
        body: [
          'Users should only upload, convert, unlock, or modify files they own or have permission to process.',
          'PDFForge should not be used to distribute copyrighted material without permission.',
        ],
      },
      {
  ...
  'file-handling': {
    ...
    eyebrow: 'File safety',
    intro: 'PDFForge is built for temporary document processing, not permanent file storage.',
    sections: [
      {
